#!/usr/bin/env python3
"""Train the isolated MutationSet query-background cross-attention variant."""
...
train_serum_mutation_set.SerumMutationSetMinusModel = SerumMutationSetMinusQueryBackgroundModel
