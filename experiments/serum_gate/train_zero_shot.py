#!/usr/bin/env python3
"""
Train SerumGate for serum-level zero-shot antigenic prediction.
"""
...
def run_training(args: argparse.Namespace) -> dict[str, Any]:
    ...
    model = SerumGateModel(model_config).to(device)
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train SerumGate.")
