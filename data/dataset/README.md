...
```bash
DATASET="H3_HA1_v1.0_HA_All"
python src/fluprofiler/dataset/raw2processed.py \
--dataset-dir "data/dataset/${DATASET}" \
--registry-csv data/embedding/registry/sequences.csv \
--embedding-files-dir data/embedding/files \
