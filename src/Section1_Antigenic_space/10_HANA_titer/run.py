...
Crick_all = pd.read_csv('/mnt/zzbnew/peixunban/chenyihao/fluProfiler_source/data/raw/all.csv')
## split train, valid, test data by strains, duplicate_cols = ['seq_a', 'seq_b', 'seq_c', 'seq_d', 'serumPassCat', 'virusPassCat', 'serumName' , 'serumName'] 
## in Crick_all have been removed
train_data, test_data =train_test_split(Crick_all, test_size=0.1, random_state=42)
