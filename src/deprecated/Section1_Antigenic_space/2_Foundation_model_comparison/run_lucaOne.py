...
emb_dict = load_embedding("../../../data/data_40/embedding_Crick_lucaOne", files=sequence_names[6486:6488])
...
early_stopping = EarlyStopping(patience=20, save_dir='../../../trained_model/lucaOne_model/')
...
for epoch in range(epochs):
    ...
    # 将epoch信息写入log.txt
    with open('../../../trained_model/lucaOne_model/log.txt', 'a') as f:
