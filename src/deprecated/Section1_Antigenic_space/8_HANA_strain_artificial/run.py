...
train_data = pd.read_csv('/mnt/zzbnew/peixunban/chenyihao/fluProfiler_source/data/data_40/strain/train.csv')
valid_data = pd.read_csv('/mnt/zzbnew/peixunban/chenyihao/fluProfiler_source/data/data_40/strain/valid.csv')
test_data = pd.read_csv('/mnt/zzbnew/peixunban/chenyihao/fluProfiler_source/data/data_40/strain/test.csv')
...
early_stopping = EarlyStopping(patience=20, save_dir='../../../trained_model/1.8_Artificial/')
...
for epoch in range(epochs):
    ...
    # 将epoch信息写入log.txt
    with open('../../../trained_model/1.8_Artificial/log.txt', 'a') as f:
