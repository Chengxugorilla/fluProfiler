...
train_data = pd.read_csv('/mnt/zzbnew/peixunban/chenyihao/fluProfiler_source/data/data_40/titer/train.csv')
test_data = pd.read_csv('/mnt/zzbnew/peixunban/chenyihao/fluProfiler_source/data/data_40/titer/test.csv')
...
IDs, embeddings = load_embedding("/mnt/zzbnew/peixunban/chenyihao/fluProfiler_source/data/data_40/embedding", files=sequence_names)
...
early_stopping = EarlyStopping(patience=20, save_dir='../../../trained_model/1.7_Artificial/')
...
for epoch in range(epochs):
    ...
    # 将epoch信息写入log.txt
    with open('../../../trained_model/1.7_Artificial/log.txt', 'a') as f:
