...
train_data_2024SH = pd.read_csv('../../data/data_40/Crick_42.csv')
train_data_2024SH[['seq_id_a', 'seq_id_b', 'seq_id_c', 'seq_id_d']] = train_data_2024SH[['seq_id_a', 'seq_id_b', 'seq_id_c', 'seq_id_d']].apply(lambda x: x + '_42')
train_data_2025NH = pd.read_csv('../../data/data_40/Crick_43.csv')
train_data_2025NH[['seq_id_a', 'seq_id_b', 'seq_id_c', 'seq_id_d']] = train_data_2025NH[['seq_id_a', 'seq_id_b', 'seq_id_c', 'seq_id_d']].apply(lambda x: x + '_43')
train_data_2025NH['serumPassCat'] = train_data_2025NH['serumPassCat'].str.replace('CELL', '<CELL>').str.replace('EGG', '<EGG>')
train_data_2025NH['virusPassCat'] = train_data_2025NH['virusPassCat'].str.replace('CELL', '<CELL>').str.replace('EGG', '<EGG>')

train_data_all = pd.concat([train_data_early, train_data_2024NH, train_data_2024SH, train_data_2025NH])
...
emb_dict_42 = load_embedding("../../data/data_40/embedding_42", map_location=device)
emb_dict_42 = {key + '_42': value for key, value in emb_dict_42.items()}
emb_dict_43 = load_embedding("../../data/data_40/embedding_43", map_location=device)
emb_dict_43 = {key + '_43': value for key, value in emb_dict_43.items()}

emb_dict = emb_dict_early | emb_dict_41 | emb_dict_42 | emb_dict_43
...
early_stopping = EarlyStopping(patience=20, save_dir='../../trained_model/Vaccine_model/model_to_2025NH/')
...
for epoch in range(epochs):
    ...
    # 将epoch信息写入log.txt
    with open('../../trained_model/Vaccine_model/model_to_2025NH/log.txt', 'a') as f:
