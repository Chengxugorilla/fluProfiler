...
train_data_all = pd.concat([train_data_early, train_data_2024NH, train_data_2024SH])
...
emb_dict = emb_dict_early | emb_dict_41 | emb_dict_42
...
early_stopping = EarlyStopping(patience=20, save_dir='../../trained_model/Vaccine_model/model_to_2024SH/')
...
for epoch in range(epochs):
    ...
    # 将epoch信息写入log.txt
    with open('../../trained_model/Vaccine_model/model_to_2024SH/log.txt', 'a') as f:
