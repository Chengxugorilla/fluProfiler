...
class fluProfiler_HANA(BertPreTrainedModel):
    def __init__(self, config, args):
        super(fluProfiler_HANA, self).__init__(config)
        if config.seq_max_length is None and config.seq_max_length_a == config.seq_max_length_b == config.seq_max_length_c == config.seq_max_length_d:
            config.seq_max_length = config.seq_max_length_a
        if config.matrix_max_length is None and config.matrix_max_length_a == config.matrix_max_length_b == config.matrix_max_length_c == config.matrix_max_length_d:
            config.matrix_max_length = config.matrix_max_length_a
...
class fluProfiler_HANA_diff(BertPreTrainedModel):
    def __init__(self, config, args):
        super(fluProfiler_HANA_diff, self).__init__(config)
        if config.seq_max_length is None and config.seq_max_length_a == config.seq_max_length_b == config.seq_max_length_c == config.seq_max_length_d:
            config.seq_max_length = config.seq_max_length_a
        if config.matrix_max_length is None and config.matrix_max_length_a == config.matrix_max_length_b == config.matrix_max_length_c == config.matrix_max_length_d:
            config.matrix_max_length = config.matrix_max_length_a
        ...
        self.dropout, self.hidden_layer, self.hidden_act, self.classifier, self.output, self.loss_fct = \
            create_loss_function(
                config,
                args,
                hidden_size=last_hidden_size * 2 + 128,
                classifier_size=args.classifier_size,
                sigmoid=args.sigmoid,
                output_mode=args.output_mode,
                num_labels=self.num_labels,
        ...
        self.Passage_encoder = nn.Sequential(
            nn.Embedding(num_embeddings=5, embedding_dim=128),
            nn.ReLU(),
            nn.Linear(128, 128),
        )
    ...
    def forward(
        ...
        concat_vector = torch.concat([representation_vector_a - representation_vector_c, representation_vector_b - representation_vector_d], dim=1)
...
class fluProfiler_HA_diff(BertPreTrainedModel):
    def __init__(self, config, args):
        super(fluProfiler_HA_diff, self).__init__(config)
        ...
        self.dropout, self.hidden_layer, self.hidden_act, self.classifier, self.output, self.loss_fct = \
            create_loss_function(
                config,
                args,
                hidden_size=last_hidden_size + 256,
                classifier_size=args.classifier_size,
                sigmoid=args.sigmoid,
                output_mode=args.output_mode,
                num_labels=self.num_labels,
    ...
    def forward(
        ...
        concat_vector = representation_vector_a - representation_vector_b
...
class fluProfiler_HA(BertPreTrainedModel):
    def __init__(self, config, args):
    ...
    def forward(
        ...
        concat_vector = torch.concat([representation_vector_a, representation_vector_b], dim=1)
...
class fluProfiler_HANA_Institute(BertPreTrainedModel):
    def __init__(self, config, args):
        super(fluProfiler_HANA_Institute, self).__init__(config)
        if config.seq_max_length is None and config.seq_max_length_a == config.seq_max_length_b == config.seq_max_length_c == config.seq_max_length_d:
            config.seq_max_length = config.seq_max_length_a
        if config.matrix_max_length is None and config.matrix_max_length_a == config.matrix_max_length_b == config.matrix_max_length_c == config.matrix_max_length_d:
            config.matrix_max_length = config.matrix_max_length_a
        ...
        self.Institute_encoder = nn.Sequential(
            nn.Embedding(num_embeddings=3, embedding_dim=256),
            nn.ReLU(),
            nn.Linear(256, 256),
        )
        ...
        self.dropout, self.hidden_layer, self.hidden_act, self.classifier, self.output, self.loss_fct = \
            create_loss_function(
                config,
                args,
                hidden_size=last_hidden_size * 4 + 256 + 256,
                classifier_size=args.classifier_size,
                sigmoid=args.sigmoid,
                output_mode=args.output_mode,
                num_labels=self.num_labels,
    ...
    def forward(
            ...
            matrices_a=None, matrices_b=None, matrices_c=None, matrices_d=None,
            matrix_attention_masks_a=None, matrix_attention_masks_b=None, matrix_attention_masks_c=None, matrix_attention_masks_d=None,
            strainPassCats=None, institute=None, labels=None,
            save_concat_vector=None,
            save_attention_path=None,
            **kwargs
    ):  
        ...
        strainPassCats_vector = torch.mean(self.Passage_encoder(strainPassCats), dim=1)
        institute_vector = torch.mean(self.Institute_encoder(institute), dim=1)
        ...
        concat_vector = torch.concat([concat_vector, strainPassCats_vector, institute_vector], dim=1)
