import sys
sys.path.append('../../')
from fluProfiler_models import fluProfiler_Config, fluProfiler_HANA_diff
...
model = fluProfiler_HANA_diff(config=fluProfiler_config, args=fluProfiler_args)
model.to(device)
...
early_stopping = EarlyStopping(patience=10, save_dir='../../../trained_model/1.9_diff/')
...
for epoch in range(epochs):
    ...
    # 将epoch信息写入log.txt
    with open('../../../trained_model/1.9_diff/log.txt', 'a') as f:
