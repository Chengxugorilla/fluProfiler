...
IDs, embeddings = load_embedding("/data/chenyihao/embedding_esm2_3b", files=sequence_names)
...
early_stopping = EarlyStopping(patience=6, save_dir='../../../trained_model/1.6_esm2_3b/')
...
for epoch in range(epochs):
    ...
    ## 将epoch信息写入log.txt
    with open('../../../trained_model/1.6_esm2_3b/log.txt', 'a') as f:
