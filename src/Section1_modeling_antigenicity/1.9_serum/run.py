...
early_stopping = EarlyStopping(patience=20, save_dir='/mnt/zzbnew/peixunban/chenyihao_133/')
...
for epoch in range(epochs):
    ...
    # 将epoch信息写入log.txt
    # with open('../../../trained_model/1.9_serum/log.txt', 'a') as f:
    with open('/mnt/zzbnew/peixunban/chenyihao_133/log.txt', 'a') as f:
