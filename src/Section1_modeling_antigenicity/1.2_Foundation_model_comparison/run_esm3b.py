...
emb_dict = load_embedding("../../../data/data_40/embedding_Crick_esm3b", files=sequence_names, map_location=device)
...
early_stopping = EarlyStopping(patience=20, save_dir='../../../trained_model/esm3b_model/')
...
for epoch in range(epochs):
    ...
    # 将epoch信息写入log.txt
    with open('../../../trained_model/esm3b_model/log.txt', 'a') as f:
