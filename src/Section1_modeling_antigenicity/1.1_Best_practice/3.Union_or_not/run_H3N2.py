...
save_dir = '/mnt/zzbnew/peixunban/chenyihao/fluProfiler_source/trained_model/1.3_H3N2_only_model/'
...
train_data_final = train_data_final[train_data_final['Type'] == 'H3N2']
valid_data = valid_data[valid_data['Type'] == 'H3N2']
test_data = test_data[test_data['Type'] == 'H3N2']
